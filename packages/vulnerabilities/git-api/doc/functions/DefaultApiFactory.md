...
Defined in: [api.ts:6175](https://github.com/Siasurai/javascript-clients/blob/main/packages/vulnerabilities/git-api/api.ts#L6175)
...
> **getAffectedPackagesBySystemCve**(`inventoryId`, `cveId`, `options?`): `AxiosPromise`\<[`SystemCvePackagesOut`](../interfaces/SystemCvePackagesOut.md)\>
...
> **getCvesWithoutErrata**(`options?`): `AxiosPromise`\<[`CvesWithoutErrataOut`](../interfaces/CvesWithoutErrataOut.md)\>
...
> **getDashbar**(`tags?`, `sapSids?`, `sapSystem?`, `ansible?`, `mssql?`, `crowdstrike?`, `ibmDb2?`, `intersystems?`, `oracleDb?`, `rhelAi?`, `satellite?`, `options?`): `AxiosPromise`\<[`DashbarOut`](../interfaces/DashbarOut.md)\>
...
> **getDashboard**(`tags?`, `sapSids?`, `sapSystem?`, `ansible?`, `mssql?`, `crowdstrike?`, `ibmDb2?`, `intersystems?`, `oracleDb?`, `rhelAi?`, `satellite?`, `options?`): `AxiosPromise`\<[`Dashboard`](../interfaces/Dashboard.md)\>
...
> **getSystemsIds**(`filter?`, `limit?`, `offset?`, `page?`, `pageSize?`, `sort?`, `dataFormat?`, `stale?`, `uuid?`, `tags?`, `sapSids?`, `sapSystem?`, `excluded?`, `rhelVersion?`, `ansible?`, `mssql?`, `crowdstrike?`, `ibmDb2?`, `intersystems?`, `oracleDb?`, `rhelAi?`, `satellite?`, `groupNames?`, `groupIds?`, `hostType?`, `options?`): `AxiosPromise`\<[`SystemIdsOut`](../interfaces/SystemIdsOut.md)\>
...
> **getSystemsList**(`filter?`, `limit?`, `offset?`, `page?`, `pageSize?`, `sort?`, `dataFormat?`, `stale?`, `uuid?`, `tags?`, `sapSids?`, `sapSystem?`, `excluded?`, `rhelVersion?`, `report?`, `ansible?`, `mssql?`, `crowdstrike?`, `ibmDb2?`, `intersystems?`, `oracleDb?`, `rhelAi?`, `satellite?`, `groupNames?`, `groupIds?`, `hostType?`, `options?`): `AxiosPromise`\<[`SystemListOut`](../interfaces/SystemListOut.md)\>
...
> **setCvesWithoutErrata**(`cvesWithoutErrataIn`, `options?`): `AxiosPromise`\<[`CvesWithoutErrataPatchOut`](../interfaces/CvesWithoutErrataPatchOut.md)\>
...
`AxiosPromise`\<[`CvesWithoutErrataPatchOut`](../interfaces/CvesWithoutErrataPatchOut.md)\>
