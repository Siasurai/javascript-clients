...
Defined in: [api.ts:5511](https://github.com/Siasurai/javascript-clients/blob/main/packages/vulnerabilities/git-api/api.ts#L5511)
...
> **getAffectedPackagesBySystemCve**(`inventoryId`, `cveId`, `options?`): `Promise`\<(`axios?`, `basePath?`) => `AxiosPromise`\<[`SystemCvePackagesOut`](../interfaces/SystemCvePackagesOut.md)\>\>
...
> **getCvesWithoutErrata**(`options?`): `Promise`\<(`axios?`, `basePath?`) => `AxiosPromise`\<[`CvesWithoutErrataOut`](../interfaces/CvesWithoutErrataOut.md)\>\>
...
> **getDashbar**(`tags?`, `sapSids?`, `sapSystem?`, `ansible?`, `mssql?`, `crowdstrike?`, `ibmDb2?`, `intersystems?`, `oracleDb?`, `rhelAi?`, `satellite?`, `options?`): `Promise`\<(`axios?`, `basePath?`) => `AxiosPromise`\<[`DashbarOut`](../interfaces/DashbarOut.md)\>\>
...
> **getDashboard**(`tags?`, `sapSids?`, `sapSystem?`, `ansible?`, `mssql?`, `crowdstrike?`, `ibmDb2?`, `intersystems?`, `oracleDb?`, `rhelAi?`, `satellite?`, `options?`): `Promise`\<(`axios?`, `basePath?`) => `AxiosPromise`\<[`Dashboard`](../interfaces/Dashboard.md)\>\>
...
> **getSystemsIds**(`filter?`, `limit?`, `offset?`, `page?`, `pageSize?`, `sort?`, `dataFormat?`, `stale?`, `uuid?`, `tags?`, `sapSids?`, `sapSystem?`, `excluded?`, `rhelVersion?`, `ansible?`, `mssql?`, `crowdstrike?`, `ibmDb2?`, `intersystems?`, `oracleDb?`, `rhelAi?`, `satellite?`, `groupNames?`, `groupIds?`, `hostType?`, `options?`): `Promise`\<(`axios?`, `basePath?`) => `AxiosPromise`\<[`SystemIdsOut`](../interfaces/SystemIdsOut.md)\>\>
...
> **setCvesWithoutErrata**(`cvesWithoutErrataIn`, `options?`): `Promise`\<(`axios?`, `basePath?`) => `AxiosPromise`\<[`CvesWithoutErrataPatchOut`](../interfaces/CvesWithoutErrataPatchOut.md)\>\>
...
`Promise`\<(`axios?`, `basePath?`) => `AxiosPromise`\<[`CvesWithoutErrataPatchOut`](../interfaces/CvesWithoutErrataPatchOut.md)\>\>
