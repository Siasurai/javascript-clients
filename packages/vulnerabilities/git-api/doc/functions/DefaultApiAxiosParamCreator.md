...
Defined in: [api.ts:2845](https://github.com/Siasurai/javascript-clients/blob/main/packages/vulnerabilities/git-api/api.ts#L2845)
...
> **getAffectedPackagesBySystemCve**: (`inventoryId`, `cveId`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **getCvesWithoutErrata**: (`options?`) => `Promise`\<`RequestArgs`\>
...
> **getDashbar**: (`tags?`, `sapSids?`, `sapSystem?`, `ansible?`, `mssql?`, `crowdstrike?`, `ibmDb2?`, `intersystems?`, `oracleDb?`, `rhelAi?`, `satellite?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **getDashboard**: (`tags?`, `sapSids?`, `sapSystem?`, `ansible?`, `mssql?`, `crowdstrike?`, `ibmDb2?`, `intersystems?`, `oracleDb?`, `rhelAi?`, `satellite?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **getSystemsIds**: (`filter?`, `limit?`, `offset?`, `page?`, `pageSize?`, `sort?`, `dataFormat?`, `stale?`, `uuid?`, `tags?`, `sapSids?`, `sapSystem?`, `excluded?`, `rhelVersion?`, `ansible?`, `mssql?`, `crowdstrike?`, `ibmDb2?`, `intersystems?`, `oracleDb?`, `rhelAi?`, `satellite?`, `groupNames?`, `groupIds?`, `hostType?`, `options?`) => `Promise`\<`RequestArgs`\>
...
> **getSystemsList**: (`filter?`, `limit?`, `offset?`, `page?`, `pageSize?`, `sort?`, `dataFormat?`, `stale?`, `uuid?`, `tags?`, `sapSids?`, `sapSystem?`, `excluded?`, `rhelVersion?`, `report?`, `ansible?`, `mssql?`, `crowdstrike?`, `ibmDb2?`, `intersystems?`, `oracleDb?`, `rhelAi?`, `satellite?`, `groupNames?`, `groupIds?`, `hostType?`, `options?`) => `Promise`\<`RequestArgs`\>
